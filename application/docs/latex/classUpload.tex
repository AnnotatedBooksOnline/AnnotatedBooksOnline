...
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}Upload::\_\-\_\-construct (
...
{\em \$id} & Id of the upload. Default (null) will create a new upload. \\
\hline
\end{DoxyParams}
...
\subsubsection[{createEmptyUpload}]{\setlength{\rightskip}{0pt plus 5cm}static Upload::createEmptyUpload (
\begin{DoxyParamCaption}
\item[{\$}]{userId, }
\item[{\$}]{filename, }
\item[{\$}]{size}
...
\subsubsection[{fromToken}]{\setlength{\rightskip}{0pt plus 5cm}static Upload::fromToken (
\begin{DoxyParamCaption}
\item[{\$}]{token}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\begin{DoxyParams}{Parameters}
{\em \$token} & Token to lookup upload by.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
{\em \hyperlink{classEntityException}{EntityException}} & If upload could not be found. \\
\hline
\end{DoxyExceptions}
...
\hypertarget{classUpload_a4a6ec727bce54cbe5e60ad19963f4cb4}{
\index{Upload@{Upload}!setContent@{setContent}}
\index{setContent@{setContent}!Upload@{Upload}}
\subsubsection[{setContent}]{\setlength{\rightskip}{0pt plus 5cm}Upload::setContent (
\begin{DoxyParamCaption}
\item[{\$}]{filename, }
...
\begin{DoxyParams}{Parameters}
{\em \$filename} & Filename with new content. \\
\hline
{\em \$move} & Whether to move file. Otherwise a copy is assumed. \\
\hline
\end{DoxyParams}
