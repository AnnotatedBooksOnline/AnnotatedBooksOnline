...
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}JavascriptMinifier::\_\-\_\-construct (
...
string & {\em \$input} & Javascript to be minified. \\
\hline
\end{DoxyParams}
...
\subsubsection[{action}]{\setlength{\rightskip}{0pt plus 5cm}JavascriptMinifier::action (
\begin{DoxyParamCaption}
\item[{\$}]{command}
\end{DoxyParamCaption}
...
{\em \hyperlink{classJavascriptMinifierException}{JavascriptMinifierException}} & If parser errors are found:
\begin{DoxyItemize}
...
\begin{DoxyParams}[1]{Parameters}
int & {\em \$command} & One of class constants: ACTION\_\-KEEP\_\-A Output A. Copy B to A. Get the next B. ACTION\_\-DELETE\_\-A Copy B to A. Get the next B. (Delete A). ACTION\_\-DELETE\_\-A\_\-B Get the next B. (Delete B). \\
\hline
\end{DoxyParams}
...
\subsubsection[{isAlphaNum}]{\setlength{\rightskip}{0pt plus 5cm}JavascriptMinifier::isAlphaNum (
\begin{DoxyParamCaption}
\item[{\$}]{c}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
\subsubsection[{minify}]{\setlength{\rightskip}{0pt plus 5cm}static JavascriptMinifier::minify (
\begin{DoxyParamCaption}
\item[{\$}]{js}
\end{DoxyParamCaption}
...
\begin{DoxyExceptions}{Exceptions}
{\em \hyperlink{classJavascriptMinifierException}{JavascriptMinifierException}} & On unterminated comment. \\
\hline
\end{DoxyExceptions}
\begin{DoxyReturn}{Returns}
string 
