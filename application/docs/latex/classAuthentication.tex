...
\subsubsection[{assertPermissionTo}]{\setlength{\rightskip}{0pt plus 5cm}static Authentication::assertPermissionTo (
\begin{DoxyParamCaption}
\item[{\$}]{action}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
string & {\em \$action} & The name of the action, there should be an entry with it in the Permissions table.\\
\hline
\end{DoxyParams}

\begin{DoxyExceptions}{Exceptions}
{\em \hyperlink{classAccessDeniedException}{AccessDeniedException}} & If the current user has no permission. \\
\hline
\end{DoxyExceptions}
...
\subsubsection[{checkPassword}]{\setlength{\rightskip}{0pt plus 5cm}Authentication::checkPassword (
\begin{DoxyParamCaption}
\item[{\$}]{password}
\end{DoxyParamCaption}
)}}
...
{\em \$password} & The password of the user to check.\\
\hline
\end{DoxyParams}
...
\subsubsection[{hasPermissionTo}]{\setlength{\rightskip}{0pt plus 5cm}Authentication::hasPermissionTo (
\begin{DoxyParamCaption}
\item[{\$}]{action}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{login}]{\setlength{\rightskip}{0pt plus 5cm}Authentication::login (
\begin{DoxyParamCaption}
\item[{\$}]{username, }
\item[{\$}]{password}
\end{DoxyParamCaption}
...
\begin{DoxyParams}{Parameters}
{\em \$username} & The username of the user to log in. \\
\hline
{\em \$password} & The password of the user to log in.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The new user.
