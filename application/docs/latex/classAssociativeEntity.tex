...
Inheritance diagram for AssociativeEntity:\begin{figure}[H]
\begin{center}
\leavevmode
\includegraphics[height=2.847458cm]{classAssociativeEntity}
\end{center}
\end{figure}
...
\subsubsection[{getInsertQuery}]{\setlength{\rightskip}{0pt plus 5cm}AssociativeEntity::getInsertQuery (
