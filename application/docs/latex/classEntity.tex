...
\subsubsection[{getAllValues}]{\setlength{\rightskip}{0pt plus 5cm}Entity::getAllValues (
\begin{DoxyParamCaption}
...
\subsubsection[{getInsertQuery}]{\setlength{\rightskip}{0pt plus 5cm}Entity::getInsertQuery (
\begin{DoxyParamCaption}
\item[{\$}]{returning = {\ttfamily false}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
...
{\em \$returning} & If true, a returning clause is added to the query which returns all primary keys.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\hypertarget{classEntity_a61bbfbb4058427174e002a09ddc77c41}{
...
\subsubsection[{getTypes}]{\setlength{\rightskip}{0pt plus 5cm}static Entity::getTypes (
\begin{DoxyParamCaption}
\item[{\$}]{default = {\ttfamily true}}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{getValues}]{\setlength{\rightskip}{0pt plus 5cm}Entity::getValues (
\begin{DoxyParamCaption}
...
\begin{DoxyParams}{Parameters}
{\em \$values} & Array of names to fetch, or null if you want to fetch everything. \\
\hline
\end{DoxyParams}
...
\subsubsection[{setRawValues}]{\setlength{\rightskip}{0pt plus 5cm}Entity::setRawValues (
\begin{DoxyParamCaption}
\item[{\$}]{values}
\end{DoxyParamCaption}
)}}
...
\subsubsection[{setValues}]{\setlength{\rightskip}{0pt plus 5cm}Entity::setValues (
\begin{DoxyParamCaption}
\item[{\$}]{values}
\end{DoxyParamCaption}
)}}
