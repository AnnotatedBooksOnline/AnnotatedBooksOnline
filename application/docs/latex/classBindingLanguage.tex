...
\subsubsection[{\_\-\_\-construct}]{\setlength{\rightskip}{0pt plus 5cm}BindingLanguage::\_\-\_\-construct (
\begin{DoxyParamCaption}
\item[{\$}]{bindingId = {\ttfamily null}, }
\item[{\$}]{languageId = {\ttfamily null}, }
...
{\em \$languageId} & \\
\hline
{\em \$createNew} & If true, a new relation will be created if the specified one did not exist yet. If one already exists, it doesn't really matter whether this is true or false. \\
\hline
\end{DoxyParams}
...
\subsubsection[{createOrGet}]{\setlength{\rightskip}{0pt plus 5cm}static BindingLanguage::createOrGet (
\begin{DoxyParamCaption}
\item[{\$}]{binding, }
\item[{\$}]{language}
\end{DoxyParamCaption}
...
\hyperlink{classBinding}{Binding} & {\em \$binding} & \\
\hline
\hyperlink{classLanguage}{Language} & {\em \$language} & \\
\hline
\end{DoxyParams}
\hypertarget{classBindingLanguage_a98dcffedcdfc0ebe0701353fd2d17d06}{
