...
\item 
\hypertarget{classUser_aacdf3281577d0916a6e3910ad93d1a43}{
{\bfseries setActive} (\$active)}
\label{classUser_aacdf3281577d0916a6e3910ad93d1a43}
...
{\em \$id} & Id of the user. Default (null) will create a new user. \\
\hline
\end{DoxyParams}
...
\subsubsection[{checkPassword}]{\setlength{\rightskip}{0pt plus 5cm}static User::checkPassword (
\begin{DoxyParamCaption}
\item[{\$}]{userId, }
\item[{\$}]{password}
\end{DoxyParamCaption}
...
\subsubsection[{fromEmailAddress}]{\setlength{\rightskip}{0pt plus 5cm}static User::fromEmailAddress (
\begin{DoxyParamCaption}
\item[{\$}]{email}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
string & {\em \$email} & An e-\/mail address.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\subsubsection[{fromUsername}]{\setlength{\rightskip}{0pt plus 5cm}static User::fromUsername (
\begin{DoxyParamCaption}
\item[{\$}]{username}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\begin{DoxyParams}[1]{Parameters}
string & {\em \$username} & The name of the user to load.\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
{\em \hyperlink{classEntityException}{EntityException}} & If the user does not exist. \\
\hline
\end{DoxyExceptions}
...
\subsubsection[{fromUsernameAndPassword}]{\setlength{\rightskip}{0pt plus 5cm}static User::fromUsernameAndPassword (
\begin{DoxyParamCaption}
\item[{\$}]{username, }
\item[{\$}]{password}
\end{DoxyParamCaption}
...
\begin{DoxyExceptions}{Exceptions}
{\em \hyperlink{classUserBannedException}{UserBannedException}} & If the user is banned. \\
\hline
{\em \hyperlink{classUserPendingException}{UserPendingException}} & If the user is not yet activated. \\
\hline
{\em \hyperlink{classUserNotFoundException}{UserNotFoundException}} & If no user with the provided username/password combination exists. \\
\hline
\end{DoxyExceptions}
...
\subsubsection[{\$active}]{\setlength{\rightskip}{0pt plus 5cm}User::\$active\hspace{0.3cm}{\ttfamily  \mbox{[}protected\mbox{]}}}}
