...
\hypertarget{classEntityList_a9780f5f54e8f05f04e152685aa6a443d}{
\index{EntityList@{EntityList}!buildSelectionQuery@{buildSelectionQuery}}
\index{buildSelectionQuery@{buildSelectionQuery}!EntityList@{EntityList}}
\subsubsection[{buildSelectionQuery}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::buildSelectionQuery ()\hspace{0.3cm}{\ttfamily  \mbox{[}static, protected\mbox{]}}}}
...
\subsubsection[{find}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::find (\$ {\em conditions} = {\ttfamily array()}, \/  \$ {\em offset} = {\ttfamily 0}, \/  \$ {\em limit} = {\ttfamily null}, \/  \$ {\em ordering} = {\ttfamily array()}, \/  \&\$ {\em total} = {\ttfamily null})\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\index{EntityList@{EntityList}!getByKeyValue@{getByKeyValue}}
\index{getByKeyValue@{getByKeyValue}!EntityList@{EntityList}}
...
\subsubsection[{getColumns}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::getColumns ()\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\index{EntityList@{EntityList}!getEntities@{getEntities}}
\index{getEntities@{getEntities}!EntityList@{EntityList}}
...
\subsubsection[{getPrimaryKeys}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::getPrimaryKeys ()\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{getTableName}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::getTableName ()\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{getTotal}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::getTotal ()\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{getType}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::getType ()\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\subsubsection[{getTypes}]{\setlength{\rightskip}{0pt plus 5cm}static EntityList::getTypes (\$ {\em default} = {\ttfamily true})\hspace{0.3cm}{\ttfamily  \mbox{[}static\mbox{]}}}}
...
\index{EntityList@{EntityList}!load@{load}}
\index{load@{load}!EntityList@{EntityList}}
...
\index{EntityList@{EntityList}!markAllAsDeleted@{markAllAsDeleted}}
\index{markAllAsDeleted@{markAllAsDeleted}!EntityList@{EntityList}}
...
\index{EntityList@{EntityList}!markAllAsUpdated@{markAllAsUpdated}}
\index{markAllAsUpdated@{markAllAsUpdated}!EntityList@{EntityList}}
