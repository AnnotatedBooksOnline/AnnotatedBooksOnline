...
DELETE FROM HelpContents WHERE helpParagraphId IN (1, 2, 3, 4, 7, 8, 9, 10, 11, 12, 15, 18, 19, 20, 21, 22, 23, 24, 25, 26, 28, 29, 30, 31, 37);
DELETE FROM HelpParagraphs WHERE paragraphParentId IN (1, 2, 3, 4, 7, 8, 9, 10, 11, 12, 15, 18, 19, 20, 21, 22, 23, 24, 25, 26, 28, 29, 30, 31, 37);
DELETE FROM HelpParagraphs WHERE helpParagraphId IN (1, 2, 3, 4, 7, 8, 9, 10, 11, 12, 15, 18, 19, 20, 21, 22, 23, 24, 25, 26, 28, 29, 30, 31, 37);
DELETE FROM HelpPages WHERE helpPageId IN (4, 5);

UPDATE HelpContents SET content = 
'<p>
...
UPDATE HelpContents SET content = '' WHERE helpContentId = 10;

UPDATE HelpParagraphs SET title = 'Zooming' WHERE helpParagraphId = 14;
UPDATE HelpContents SET content = 
'<p>
...
UPDATE HelpParagraphs SET title = 'Navigating around the page' WHERE helpParagraphId = 16;
UPDATE HelpContents SET content = 
'<p>
...
UPDATE HelpParagraphs SET title = 'Rotating the view' WHERE helpParagraphId = 17;
UPDATE HelpContents SET content = 
'<p>
...
UPDATE HelpParagraphs SET title = 'Linking to a page' WHERE helpParagraphId = 27;
UPDATE HelpContents SET content = 
'<p>
...
UPDATE HelpParagraphs SET title = 'Working with annotations' WHERE helpParagraphId = 38;
UPDATE HelpContents SET content =
'<p>
...
UPDATE HelpParagraphs SET title = 'Add an annotation' WHERE helpParagraphId = 39;
UPDATE HelpContents SET content =
'<p>
...
UPDATE HelpParagraphs SET title = 'Add information' WHERE helpParagraphId = 40;
UPDATE HelpContents SET content =
'<p>
    Before you proceed, you must be **in edit mode||Viewer/Annotations/Working with annotations**.
</p>
...
UPDATE HelpParagraphs SET title = 'Remove an annotation' WHERE helpParagraphId = 42;
UPDATE HelpContents SET content =
'<p>
    Before you proceed, you must be **in edit mode||Viewer/Annotations/Working with annotations**.
</p>
...
INSERT INTO HelpParagraphs (helpParagraphId, paragraphParentId, helpPageId, title) VALUES (43, NULL, 6, 'Export to PDF');
INSERT INTO HelpContents (helpParagraphId, content) VALUES (43, 
'<p>
...
UPDATE HelpPages SET helpType = 'view' WHERE helpPageId = 6;
