...
INSERT INTO "##PREFIX##Settings" ("settingName", "settingValue") VALUES ('show-welcome-page', '0');

-- The setting info-button specifies whether the Info button should be shown in the application.
INSERT INTO "##PREFIX##Settings" ("settingName", "settingValue") VALUES ('info-button', '0');
