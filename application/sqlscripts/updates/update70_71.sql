...
INSERT INTO "HelpParagraphs" ("helpPageId", "title", "actionName") VALUES ((SELECT "helpPageId" FROM "HelpPages" WHERE "pageName" = 'Upload'), 'About uploading', 'upload-bindings');
INSERT INTO "HelpParagraphs" ("helpPageId", "title", "actionName") VALUES ((SELECT "helpPageId" FROM "HelpPages" WHERE "pageName" = 'Upload'), 'Uploading books', 'upload-bindings');
INSERT INTO "HelpParagraphs" ("helpPageId", "title", "actionName") VALUES ((SELECT "helpPageId" FROM "HelpPages" WHERE "pageName" = 'Upload'), 'Binding information', 'upload-bindings');
INSERT INTO "HelpParagraphs" ("helpPageId", "title", "actionName") VALUES ((SELECT "helpPageId" FROM "HelpPages" WHERE "pageName" = 'Upload'), 'Book information', 'upload-bindings');

--Insert upload into HelpContents
INSERT INTO "HelpContents" ("helpParagraphId", content) VALUES  ((SELECT "helpParagraphId" FROM "HelpParagraphs" WHERE title = 'About uploading'), '<p>
...
INSERT INTO "HelpContents" ("helpParagraphId", content) VALUES  ((SELECT "helpParagraphId" FROM "HelpParagraphs" WHERE title = 'Uploading books'), '<p>
...
INSERT INTO "HelpContents" ("helpParagraphId", content) VALUES  ((SELECT "helpParagraphId" FROM "HelpParagraphs" WHERE title = 'Binding information'), '<p>
...
INSERT INTO "HelpContents" ("helpParagraphId", content) VALUES  ((SELECT "helpParagraphId" FROM "HelpParagraphs" WHERE title = 'Book information'), '<p>
